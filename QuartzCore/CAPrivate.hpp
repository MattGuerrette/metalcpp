...
namespace CA
{
    namespace Private
    {
        namespace Selector
        {
            ...
            _CA_PRIVATE_DEF_SEL(drawable, "drawable");
            _CA_PRIVATE_DEF_SEL(delegate, "delegate");
            _CA_PRIVATE_DEF_SEL(initWithMetalLayer, "initWithMetalLayer:");
            ...
            _CA_PRIVATE_DEF_SEL(addToRunLoop_, "addToRunLoop:forMode:");
