...
namespace NS::Private::Selector
{
    ...
    _APPKIT_PRIVATE_DEF_SEL(layer_, "layer");

    _APPKIT_PRIVATE_DEF_SEL(setLayer_, "setLayer:");

    _APPKIT_PRIVATE_DEF_SEL(windows, "windows");

    _APPKIT_PRIVATE_DEF_SEL(openPanel_, "openPanel");

    _APPKIT_PRIVATE_DEF_SEL(beginSheetModalForWindow_completionHandler_, "beginSheetModalForWindow:completionHandler:");
