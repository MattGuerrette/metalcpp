...
namespace NS
{
    _NS_OPTIONS(NS::UInteger, WindowStyleMask){ WindowStyleMaskBorderless             = 0,
    ...
    _NS_ENUM(NS::UInteger,
             BackingStoreType){ BackingStoreRetained = 0, BackingStoreNonretained = 1, BackingStoreBuffered = 2 };

    _NS_ENUM(NS::UInteger,
             ActivationPolicy){ ActivationPolicyRegular, ActivationPolicyAccessory, ActivationPolicyProhibited };
    ...
    public:
        ...
        virtual bool applicationShouldTerminateAfterLastWindowClosed([[maybe_unused]] class Application* pSender)
        {
            return false;
        }
    };
...
{
    return Object::sendMessage<Application*>(_APPKIT_PRIVATE_CLS(NSApplication),
...
_NS_INLINE void NS::Application::run() { Object::sendMessage<void>(this, _APPKIT_PRIVATE_SEL(run)); }
