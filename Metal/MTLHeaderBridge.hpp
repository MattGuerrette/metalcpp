...
namespace MTL::Private::Selector
{
    ...
    _MTL_PRIVATE_DEF_SEL(barrierAfterQueueStages_beforeStages_, "barrierAfterQueueStages:beforeStages:");
    ...
    _MTL_PRIVATE_DEF_SEL(beginCommandBufferWithAllocator_options_, "beginCommandBufferWithAllocator:options:");
    ...
    _MTL_PRIVATE_DEF_SEL(dispatchNetworkWithIntermediatesHeap_, "dispatchNetworkWithIntermediatesHeap:");
    ...
    _MTL_PRIVATE_DEF_SEL(
        ...
        "drawIndexedPatches:patchStart:patchCount:patchIndexBuffer:patchIndexBufferOffset:controlPointIndexBuffer:"
        "controlPointIndexBufferOffset:instanceCount:baseInstance:tessellationFactorBuffer:"
    ...
    _MTL_PRIVATE_DEF_SEL(
        ...
        "drawIndexedPrimitives:indexCount:indexType:indexBuffer:indexBufferOffset:instanceCount:baseVertex:"
        "baseInstance:");
    ...
    _MTL_PRIVATE_DEF_SEL(executeCommandsInBuffer_indirectBuffer_, "executeCommandsInBuffer:indirectBuffer:");
    ...
    _MTL_PRIVATE_DEF_SEL(functionHandleWithBinaryFunction_stage_, "functionHandleWithBinaryFunction:stage:");
    ...
    _MTL_PRIVATE_DEF_SEL(newArgumentTableWithDescriptor_error_, "newArgumentTableWithDescriptor:error:");
    ...
    _MTL_PRIVATE_DEF_SEL(newBinaryFunctionWithDescriptor_error_, "newBinaryFunctionWithDescriptor:error:");
    ...
    _MTL_PRIVATE_DEF_SEL(newCommandAllocatorWithDescriptor_error_, "newCommandAllocatorWithDescriptor:error:");
    ...
    _MTL_PRIVATE_DEF_SEL(newComputePipelineStateWithDescriptor_error_, "newComputePipelineStateWithDescriptor:error:");
    ...
    _MTL_PRIVATE_DEF_SEL(newDynamicLibraryWithURL_completionHandler_, "newDynamicLibraryWithURL:completionHandler:");
    ...
    _MTL_PRIVATE_DEF_SEL(newLibraryWithDescriptor_completionHandler_, "newLibraryWithDescriptor:completionHandler:");
    ...
    _MTL_PRIVATE_DEF_SEL(newMTL4CommandQueueWithDescriptor_error_, "newMTL4CommandQueueWithDescriptor:error:");
    ...
    _MTL_PRIVATE_DEF_SEL(newPipelineDataSetSerializerWithDescriptor_, "newPipelineDataSetSerializerWithDescriptor:");
    ...
    _MTL_PRIVATE_DEF_SEL(newRenderPipelineDescriptorForSpecialization, "newRenderPipelineDescriptorForSpecialization");
    ...
    _MTL_PRIVATE_DEF_SEL(newTensorWithDescriptor_offset_error_, "newTensorWithDescriptor:offset:error:");
    _MTL_PRIVATE_DEF_SEL(newTextureViewPoolWithDescriptor_error_, "newTextureViewPoolWithDescriptor:error:");
    ...
    _MTL_PRIVATE_DEF_SEL(renderCommandEncoderWithDescriptor_options_, "renderCommandEncoderWithDescriptor:options:");
    ...
    _MTL_PRIVATE_DEF_SEL(serializeAsArchiveAndFlushToURL_error_, "serializeAsArchiveAndFlushToURL:error:");
    ...
    _MTL_PRIVATE_DEF_SEL(setMachineLearningFunctionDescriptor_, "setMachineLearningFunctionDescriptor:");
    ...
    _MTL_PRIVATE_DEF_SEL(setMaxCompatiblePlacementSparsePageSize_, "setMaxCompatiblePlacementSparsePageSize:");
    ...
    _MTL_PRIVATE_DEF_SEL(setRequiredThreadsPerMeshThreadgroup_, "setRequiredThreadsPerMeshThreadgroup:");
    _MTL_PRIVATE_DEF_SEL(setRequiredThreadsPerObjectThreadgroup_, "setRequiredThreadsPerObjectThreadgroup:");
    ...
    _MTL_PRIVATE_DEF_SEL(updateBufferMappings_heap_operations_count_, "updateBufferMappings:heap:operations:count:");
    ...
    _MTL_PRIVATE_DEF_SEL(updateTextureMappings_heap_operations_count_, "updateTextureMappings:heap:operations:count:");
