...
namespace MTLFX
{
    ...
    public:
        ...
        [[nodiscard]] MTL::PixelFormat colorTextureFormat() const;
        void setColorTextureFormat(MTL::PixelFormat format);

        [[nodiscard]] MTL::PixelFormat depthTextureFormat() const;
        void setDepthTextureFormat(MTL::PixelFormat format);

        [[nodiscard]] MTL::PixelFormat motionTextureFormat() const;
        void setMotionTextureFormat(MTL::PixelFormat format);

        [[nodiscard]] MTL::PixelFormat outputTextureFormat() const;
        void setOutputTextureFormat(MTL::PixelFormat format);

        [[nodiscard]] NS::UInteger inputWidth() const;
        void setInputWidth(NS::UInteger width);

        [[nodiscard]] NS::UInteger inputHeight() const;
        void setInputHeight(NS::UInteger height);

        [[nodiscard]] NS::UInteger outputWidth() const;
        void setOutputWidth(NS::UInteger width);

        [[nodiscard]] NS::UInteger outputHeight() const;
        void setOutputHeight(NS::UInteger height);

        [[nodiscard]] bool isAutoExposureEnabled() const;
        void setAutoExposureEnabled(bool enabled);

        [[nodiscard]] bool isInputContentPropertiesEnabled() const;
        void setInputContentPropertiesEnabled(bool enabled);

        [[nodiscard]] float inputContentMinScale() const;
        void setInputContentMinScale(float scale);

        [[nodiscard]] float inputContentMaxScale() const;
    ...
    {
    public:
        [[nodiscard]] MTL::TextureUsage colorTextureUsage() const;
        [[nodiscard]] MTL::TextureUsage depthTextureUsage() const;
        [[nodiscard]] MTL::TextureUsage motionTextureUsage() const;
        [[nodiscard]] MTL::TextureUsage outputTextureUsage() const;

        [[nodiscard]] NS::UInteger inputContentWidth() const;
        void setInputContentWidth(NS::UInteger width);

        [[nodiscard]] NS::UInteger inputContentHeight() const;
        void setInputContentHeight(NS::UInteger height);

        [[nodiscard]] MTL::Texture* colorTexture() const;
        void setColorTexture(MTL::Texture* pTexture);

        [[nodiscard]] MTL::Texture* depthTexture() const;
        void setDepthTexture(MTL::Texture* pTexture);

        [[nodiscard]] MTL::Texture* motionTexture() const;
        void setMotionTexture(MTL::Texture* pTexture);

        [[nodiscard]] MTL::Texture* outputTexture() const;
        void setOutputTexture(MTL::Texture* pTexture);

        [[nodiscard]] MTL::Texture* exposureTexture() const;
        void setExposureTexture(MTL::Texture* pTexture);

        [[nodiscard]] float preExposure() const;
        void setPreExposure(float preExposure);

        [[nodiscard]] float jitterOffsetX() const;
        void setJitterOffsetX(float offset);

        [[nodiscard]] float jitterOffsetY() const;
        void setJitterOffsetY(float offset);

        [[nodiscard]] float motionVectorScaleX() const;
        void setMotionVectorScaleX(float scale);

        [[nodiscard]] float motionVectorScaleY() const;
        void setMotionVectorScaleY(float scale);

        [[nodiscard]] bool reset() const;
        void setReset(bool reset);

        [[nodiscard]] bool isDepthReversed() const;
        ...
        [[nodiscard]] MTL::Fence* fence() const;
...
_MTLFX_INLINE float MTLFX::TemporalScalerDescriptor::supportedInputContentMinScale(const MTL::Device* pDevice)
{
    ...
    if (nullptr != methodSignatureForSelector(
        _NS_PRIVATE_CLS(MTLFXTemporalScalerDescriptor), _MTLFX_PRIVATE_SEL(supportedInputContentMinScaleForDevice_)))
    {
...
_MTLFX_INLINE float MTLFX::TemporalScalerDescriptor::supportedInputContentMaxScale(const MTL::Device* pDevice)
{
    ...
    if (nullptr != methodSignatureForSelector(
        _NS_PRIVATE_CLS(MTLFXTemporalScalerDescriptor), _MTLFX_PRIVATE_SEL(supportedInputContentMaxScaleForDevice_)))
    {
        scale = sendMessage<float>(
            _NS_PRIVATE_CLS(MTLFXTemporalScalerDescriptor), _MTLFX_PRIVATE_SEL(supportedInputContentMaxScaleForDevice_),
            pDevice);
