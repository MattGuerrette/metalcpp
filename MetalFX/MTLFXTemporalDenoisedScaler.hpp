    ...
    bool requiresSynchronousInitialization)
{
    return NS::Object::sendMessage<void>(
        this, _MTLFX_PRIVATE_SEL(setRequiresSynchronousInitialization_), requiresSynchronousInitialization);
}
...
_MTLFX_INLINE bool MTLFX::TemporalDenoisedScalerDescriptor::supportsMetal4FX(MTL::Device* device)
{
    return NS::Object::sendMessageSafe<bool>(
        _MTLFX_PRIVATE_CLS(MTLFXTemporalDenoisedScalerDescriptor), _MTLFX_PRIVATE_SEL(supportsMetal4FX_), device);
}
...
{
    return NS::Object::sendMessageSafe<bool>(
        _MTLFX_PRIVATE_CLS(MTLFXTemporalDenoisedScalerDescriptor), _MTLFX_PRIVATE_SEL(supportsDevice_), device);
}
...
{
    return NS::Object::sendMessage<void>(
        this, _MTLFX_PRIVATE_SEL(setSpecularHitDistanceTexture_), specularHitDistanceTexture);
}
...
{
    return NS::Object::sendMessage<void>(
        this, _MTLFX_PRIVATE_SEL(setDenoiseStrengthMaskTexture_), denoiseStrengthMaskTexture);
}
...
{
    return NS::Object::sendMessage<void>(
        this, _MTLFX_PRIVATE_SEL(setTransparencyOverlayTexture_), transparencyOverlayTexture);
}
