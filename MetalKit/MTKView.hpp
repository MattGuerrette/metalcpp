...
namespace MTK
{
    ...
    public:
        ...
        virtual void drawableSizeWillChange([[maybe_unused]] View* pView, [[maybe_unused]] CGSize size) {}
    };
...
_NS_INLINE MTK::View* MTK::View::alloc() { return NS::Object::alloc<View>(_MTK_PRIVATE_CLS(MTKView)); }
...
_NS_INLINE void MTK::View::setDelegate(const MTK::ViewDelegate* pDelegate)
{
    ...
    void (*drawableSizeWillChange)(NS::Value*, SEL, View*, CGSize) =
        [](NS::Value* pSelf, SEL, View* pMTKView, CGSize size)
    {
        auto pDel = reinterpret_cast<MTK::ViewDelegate*>(pSelf->pointerValue());
    ...
    objc_setAssociatedObject(
        (__bridge id)pWrapper, "mtkviewdelegate_cpp", (__bridge id)pWrapper, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
#else
...
_NS_INLINE bool MTK::View::isPaused() const { return NS::Object::sendMessage<bool>(this, _MTK_PRIVATE_SEL(isPaused)); }
