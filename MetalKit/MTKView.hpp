...
_NS_INLINE void MTK::View::setDelegate(const MTK::ViewDelegate* pDelegate)
{
    ...
    class_addMethod((Class)objc_lookUpClass("NSValue"), sel_registerName("mtkView:drawableSizeWillChange:"),
                    (IMP)drawableSizeWillChange, cbparams);
...
{
    auto* pWrapper = NS::Object::sendMessage<NS::Value*>(this, _MTK_PRIVATE_SEL(delegate));
    if (pWrapper)
    {
