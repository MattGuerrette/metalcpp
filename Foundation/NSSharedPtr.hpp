...
namespace NS
{
    ...
    public:
        ...
        SharedPtr(const SharedPtr<_OtherClass>& other,
                  std::enable_if_t<std::is_convertible_v<_OtherClass*, _Class*>>* = nullptr) noexcept;
         ...
         */
        template<class _OtherClass>
        std::enable_if_t<std::is_convertible_v<_OtherClass*, _Class*>, SharedPtr&> operator=(
...
template<class _Class>
_NS_INLINE NS::SharedPtr<_Class>::SharedPtr(const SharedPtr& other) noexcept : m_pObject(other.m_pObject->retain())
{
}
...
_NS_INLINE NS::SharedPtr<_Class>::SharedPtr(const SharedPtr<_OtherClass>& other,
                                            std::enable_if_t<std::is_convertible_v<_OtherClass*, _Class*>>*) noexcept
    : m_pObject(reinterpret_cast<_Class*>(other.get()->retain()))
{
}

template<class _Class>
_NS_INLINE NS::SharedPtr<_Class>::SharedPtr(SharedPtr&& other) noexcept : m_pObject(other.m_pObject)
{
...
template<class _Class>
_NS_INLINE NS::SharedPtr<_Class>& NS::SharedPtr<_Class>::operator=(const SharedPtr& other)
...
template<class _Class>
template<class _OtherClass>
std::enable_if_t<std::is_convertible_v<_OtherClass*, _Class*>, NS::SharedPtr<_Class>&> _NS_INLINE
...
template<class _Class>
_NS_INLINE NS::SharedPtr<_Class>& NS::SharedPtr<_Class>::operator=(SharedPtr&& other) noexcept
    __attribute__((no_sanitize("undefined")))
{
